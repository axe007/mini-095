...
public class ActivityController {
    ...
    public void createActivity(String name, String content, LocalDate startDate, LocalDate endDate, String activityType) {
    ...
    public void assignActivity(String activityType, String activityId, String assigneeId) {
    ...
    public void changeActivityStatus(String activityId) {
