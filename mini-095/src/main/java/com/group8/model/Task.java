...
public class Task extends Activity {
    ...
    public Task(ObjectId grandId, ObjectId parentId, String name, String description, LocalDate startDate,
            LocalDate endDate, Double estimatedHours, double priority) {
    ...
    public void setGrandId(ObjectId grandId) {
        this.grandId = grandId;
    }
    ...
    public String toString() {
        return "ID: " + this.getId() + " " + this.getName() + " : " + this.getDescription() + " Start: "
                ...
                + " Current Status: " + this.getActivityStatus();
    }
}